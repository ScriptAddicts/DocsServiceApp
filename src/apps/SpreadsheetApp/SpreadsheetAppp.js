  ...
  SpreadsheetAppp = function () {
    ...
    class SpreadsheetAppp {
      constructor(id_) {
        ...
        if (id_ !== "create") {
          if (
            id_ === "" ||
            DriveApp.getFileById(id_).getMimeType() !== MimeType.GOOGLE_SHEETS
          ) {
            putError.call(
              this,
              "This file ID is not the file ID of Spreadsheet."
            );
          }
          this.obj = {
            spreadsheetId: id_,
      ...
      getImages() {
        ...
        if (this.obj.hasOwnProperty("sheetName")) {
          return new ExcelApp(this.mainObj.blob)
            .getSheetByName(this.obj.sheetName)
            .getImages();
        } else {
          return new ExcelApp(this.mainObj.blob)
            .getAll()
      ...
      insertImage(objAr_) {
        var ar,
          ...
          xlsxObj;
        if (
          !Array.isArray(objAr_) ||
          objAr_.some(({ blob, range }) => {
            var identification;
            if (
              blob.toString() !== "Blob" ||
              !range.row ||
              ...
              console.log(
                "[DocsServiceApp]",
                "Issue with Blob or range coordinates"
              );
              return true;
            }
        ...
        try {
          ...
          if (e.message === "Sheets is not defined") {
            putError.call(
              this,
              "Please enable Sheets API at Advanced Google services, and try again."
            );
          } else {
            putError.call(this, e.message);
          }
    ...
    gToM = function () {
      ...
      if (obj.getResponseCode() !== 200) {
        putError.call(
          this,
          "Spreadsheet ID might be not correct. Please check it again."
        );
      }
      ...
      return ar_.reduce((ar, e, i) => {
        ...
        switch (mimeType) {
          ...
          default:
            putError.call(
              this,
              "In the current stage, this file type cannot be used."
            );
        }
        filename = `xl/media/image${i + 1}.${ext}`;
        dupObj = dupCheckAr.filter((e) => {
          return (
            e.orgFilename === orgFilename &&
            e.fileSize === fileSize &&
            e.mimeType === mimeType
          );
        });
    ...
    ContentTypesXml_ = function (obj, ar) {
      ...
      mimeTypes.forEach((e) => {
        var Default;
        Default = XmlService.createElement("Default", n)
          .setAttribute("ContentType", e)
          .setAttribute("Extension", mimeTypeToExtension[e]);
    ...
    createSheet1Xml_ = function (obj, ar) {
      ...
      ar.forEach((e) => {
        var c, row;
        c = XmlService.createElement("c", n)
          .setAttribute("r", e.range)
          .setAttribute("s", "1");
        row = XmlService.createElement("row", n)
          .setAttribute("r", e.rowIndex + 1)
          .addContent(c);
    ...
    createDrawing1Xml_ = function (obj, ar) {
      ...
      ar.forEach((e, i) => {
        ...
        form = XmlService.createElement("from", n)
          .addContent(col)
          .addContent(colOff)
          .addContent(row)
          .addContent(rowOff);
        ext = XmlService.createElement("ext", n)
          .setAttribute("cx", "314325")
          .setAttribute("cy", "200025");
        cNvPr = XmlService.createElement("cNvPr", n)
          .setAttribute("id", "0")
          .setAttribute("name", e.filename);
        cNvPicPr = XmlService.createElement("cNvPicPr", n).setAttribute(
          "preferRelativeResize",
          "0"
        );
        nvPicPr = XmlService.createElement("nvPicPr", n)
          .addContent(cNvPr)
          .addContent(cNvPicPr);
        blip = XmlService.createElement("blip", n3)
          .setAttribute("cstate", "print")
          .setAttribute("embed", `rId${i + 1}`, n2);
        fillRect = XmlService.createElement("fillRect", n3);
        stretch = XmlService.createElement("stretch", n3).addContent(fillRect);
        blipFill = XmlService.createElement("blipFill", n)
          .addContent(blip)
          .addContent(stretch);
        avLst = XmlService.createElement("avLst", n3);
        prstGeom = XmlService.createElement("prstGeom", n3)
          .setAttribute("prst", "rect")
          .addContent(avLst);
        spPr = XmlService.createElement("spPr", n).addContent(prstGeom);
        pic = XmlService.createElement("pic", n)
          .addContent(nvPicPr)
          .addContent(blipFill)
          .addContent(spPr);
        clientData = XmlService.createElement("clientData", n).setAttribute(
          "fLocksWithSheet",
          "0"
        );
        oneCellAnchor = XmlService.createElement("oneCellAnchor", n)
          .addContent(form)
          .addContent(ext)
          .addContent(pic)
          .addContent(clientData);
    ...
    setheaderFooter = function (obj_, obj) {
      ...
      if (obj_.hasOwnProperty("header") || obj_.hasOwnProperty("footer")) {
        ...
        unitY = "pixel";
        if (
          !obj_.header.hasOwnProperty("l") &&
          !obj_.header.hasOwnProperty("r") &&
          !obj_.header.hasOwnProperty("c") &&
          !obj_.footer.hasOwnProperty("l") &&
          !obj_.footer.hasOwnProperty("r") &&
          !obj_.footer.hasOwnProperty("c")
        ) {
        ...
        root = xmlObj.getRootElement();
        n = root.getNamespace();
        h = `&L${obj_.header.hasOwnProperty("l") ? obj_.header.l : ""}&C${
          obj_.header.hasOwnProperty("c") ? obj_.header.c : ""
        }&R${obj_.header.hasOwnProperty("r") ? obj_.header.r : ""}`;
        f = `&L${obj_.footer.hasOwnProperty("l") ? obj_.footer.l : ""}&C${
          obj_.footer.hasOwnProperty("c") ? obj_.footer.c : ""
        }&R${obj_.footer.hasOwnProperty("r") ? obj_.footer.r : ""}`;
        oddHeader = XmlService.createElement("oddHeader", n).setText(h);
        oddFooter = XmlService.createElement("oddFooter", n).setText(f);
        headerFooter = XmlService.createElement("headerFooter", n)
          .addContent(oddHeader)
          .addContent(oddFooter);
    ...
    xlsxObjToBlob = function (xlsxObj) {
      ...
      return Utilities.zip(blobs, "temp.xlsx").setContentType(
